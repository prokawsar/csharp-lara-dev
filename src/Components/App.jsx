...
class App extends Component {
  ...
  render() {
    return (
      <div>
        <a target="_blank" href="https://github.com/prokawsar/csharp-lara-dev" className="github-corner" aria-label="View source on Github">
        ...
        <br />
        <div className="hd1">Laravel and JavaScript Developer</div>
        <div className="hd-small">Well experienced laravel and javascript developer from Worldwide.</div>
